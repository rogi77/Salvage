================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Salvage プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Salvage には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Salvage アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Salvage.h
   ...
   CSalvageApp アプリケーション クラスを宣言します。

Salvage.cpp
   これは、アプリケーション クラス CSalvageApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Salvage.ico
   ...
   アイコンはメイン リソース ファイル Salvage.rc に含まれていま
   す。
...
SalvageDlg.h, SalvageDlg.cpp - ダイアログ
   これらのファイルは CSalvageDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な Salvage.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   Salvage.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
